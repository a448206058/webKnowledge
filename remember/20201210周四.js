...
/*继承
    继承的几种方式 --1-- 20201210 11:50 --2-- 20201210 13:10 --3-- 20201211 09:07 --4-- 20201211 19:58 --5-- 20201212 20:53
...
/*
    vue
        组件中的data为什么是一个函数？ 20201210 14:50 --1-- 15:00  --2-- 15:26  --3-- 20201211 09:12 --4-- 20201211 20:00 --5-- 20201212 20:55
            一个组件被复用多次的话，也就会创建多个实例。本质上，这些实例用的都是同一个构造函数
            如果data是对象的话，对象属于引用类型，会影响到所有的实例。所以为了保证组件不同实例之间data不冲突，data必须是一个函数。

        子组件为什么不可以修改父组件传递的Prop?怎么理解单向数据流 20201210 14:59 --1-- 15:04 --2-- 15:28  --3-- 20201211 09:14 --4-- 20201211 20:02 --5-- 20201212 20:58
            vue提倡单向数据流，即父级props的更新会流向子组件，但是反过来则不行
            这是为了防止意外的改变父组件状态，使得应用的数据变得难以理解
            如果破坏了单向数据流，当应用复杂时，debug的成本会非常高

        v-model是如何实现双向绑定的？ 20201210 15：24 --1-- 15:31  --2-- 16:00  --3---- 20201211 09:18 --4-- 20201211 20:05 --5-- 20201212 20:59
            v-model是用来在表单控件或组件上创建双向绑定的
            他的本质是v-bind和v-on的语法糖
            在一个组件上使用v-model，默认会为组件绑定名为value的prop和名为input的事件

        nextTick的实现原理是什么 20201210 16：00 --1-- 16:07 --2-- 16:33  --3---- 20201211 09:21 --4-- 20201211 20:06  --5-- 20201212 20:59
       ...
       vue事件绑定的原理是什么？ 20201210 16:14 --1-- 16:22 --2-- 16:44  --3---- 20201211 09:07 --4-- 20201211 20:09 --5-- 20201212 21:03
            原生事件的绑定主要是通过addEventLister来实现的，组件事件绑定主要是通过v-on来实现的

       说一下虚拟DOM以及KEY属性的作用？ 20201210 16:32 --1-- 16:36 --2-- 16:58  --3---- 20201211 09:25 --4-- 20201211 20:09. --5-- 20201212 21:03
     ...
     说一下你对vue的生命周期的理解？ 20201210 17:04  --1-- 17:10 --2-- 17:29  --3-- 20201211 09:37 --4-- 20201211 20:13 --5-- 20201212 21:03
     ...
     vue组件生命周期调用顺序是什么样的？ 20201210 17:07 --1-- 17:14 --2-- 18:15  --3-- 20201211 09:51 --4-- 20201211 20:16. --5-- 20201212 21:09
           组件调用的顺序都是先父后子，渲染完成是先子后父
           组件销毁操作是先父后子，销毁完成是先子后父

     在什么阶段才能访问操作DOM？ 20201210 17:15 --1-- 17:28 --2-- 18:15 --4-- 20201211 20:16 --5-- 20201212 21:10
        mounted
     ...
     vue理由hash模式和history模式实现原理分别是什么？他们的区别是什么？ 20201210 23:33 --1-- 23:38  --2-- 11:53   --3-- 20201211 09:52 --4-- 20201211 20:17 --5-- 20201212 21:10
        hash模式：
    ...
    路由懒加载是什么意思？如何实现路由懒加载？20201210 23:41 --1-- 23:47  --2-- 20201211 00:10    --3-- 20201211 10:02 --4-- 20201211 20:17 --5-- 20201212 21:11
        路由懒加载：就是访问的时候才加载对应的组件
        vue异步组件 resolve require resolve
        import
        webpack require ensure

    vue-router导航守卫有哪些？20201210 23:49 --1-- 23:56  --2-- 00:18    --3-- 20201211 10:04 --4-- 20201211 20:18  --5-- 20201212 21:13
        全局前置/钩子：beforeEach、beforeResolve、afterEach
        路由独享的守卫：beforeEnter
        组件内的守卫：beforeRouteEnter、beforeRouteUpdate、beforeRouteLeave

    说说vue和react的异同  20201211 00:12 --1-- 00:19  --2-- 00:35    --3-- 20201211 10:04 --4-- 20201211 20:19. --5-- 20201212 21:14
        同：
        使用virtual dom
    ...
    什么是mixin?  20201211 00:28 --1--  00:32 --2--     --3-- 20201211 10:06 --4-- 20201211 20:21. --5-- 20201212 21:16
   ...
   在vue实例中编写生命周期hook或其他option/properties时，为什么不使用箭头函数？ 20201211 00:33 --1-- 38    --3-- 20201211 10:07 --4-- 20201211 20:24  --5-- 20201212 21:17
       箭头函数自己没有定义this上下文。
       当你在vue程序中使用箭头函数时，this关键字不会绑定到vue实例，因此会引发错误，所以强烈建议该用标准函数声明

   vue模版编译原理知道吗，简单说一下？20201211 00:53 --2-- 20201211 16:13 --4-- 20201211 20:24 --5-- 20201212 21:17
